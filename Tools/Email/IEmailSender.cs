...
namespace Ansely.Email
{
    ...
    public interface IEmailSender
    {
        ...
        /// </para>
        /// </returns>
        EmailSenderResult Send(AbstractEmailTemplate template, List<string> addressees);
        ...
        /// </para>
        /// </returns>
        EmailSenderResult Send<Template>(List<string> addressees) where Template : AbstractEmailTemplate, new();
        ...
        /// </para>
        /// </returns>
        Task<EmailSenderResult> SendAsync(AbstractEmailTemplate template, List<string> addressees);
        ...
        /// </para>
        /// </returns>
        Task<EmailSenderResult> SendAsync<Template>(List<string> addressees) where Template : AbstractEmailTemplate, new();
